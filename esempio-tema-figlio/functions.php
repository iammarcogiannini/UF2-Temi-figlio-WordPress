<?php
/*Questo file è parte di prova-del-cna, twentynineteen child theme.
...
function prova_del_cna_enqueue_child_styles() {
...
add_action( 'wp_enqueue_scripts', 'prova_del_cna_enqueue_child_styles' );
